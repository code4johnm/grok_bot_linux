...
| **grok-bot-tui** | Companion TUI / Grok GUI TUI shell around the official Grok GUI (`https://grok.com`). Not a replacement for Grok. | `pip install -e ./grok-bot-tui` — see [grok-bot-tui/README.md](grok-bot-tui/README.md) |
