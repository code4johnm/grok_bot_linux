...
Companion TUI for the Grok Bot **desktop**, not a Grok wrapper. Detailed
reference: [grok-bot-tui/README.md](grok-bot-tui/README.md).
...
**0.7.1** or newer (0.3.0 showed public templates instead of your bots).
